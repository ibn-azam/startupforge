        ...
        <div className="hidden items-center gap-8 md:flex">
          <ul className="flex items-center gap-8">
            <li>
              <Link
                href="/"
                className="text-md text-[#131B3A] hover:text-[#FF6B35]"
              >
                Home
              </Link>
            </li>
          ...
          {isPending ? (
            <div>
              <Spinner className="text-[#FF6B35]" size="md" />
            </div>
          ) : user ? (
            <>
            ...
            <>
              <Link
                href="/login"
                className="text-sm font-medium text-[#131B3A] hover:text-[#FF6B35]"
              >
                Login
              </Link>
              <Link href="/signup">
        ...
        <div className="border-t border-b border-[#6B7280]/10 bg-[#FAFAFA] px-4 py-4 shadow-sm md:hidden">
          <ul className="flex flex-col gap-1">
            <li>
              <Link
                href="/"
                className="flex min-h-11 items-center rounded-lg px-3 text-md text-[#131B3A] hover:bg-[#FFF1EB] hover:text-[#FF6B35]"
              >
                Home
              </Link>
            </li>
          ...
          {isPending ? (
            ...
            <div className="mt-3 flex flex-col gap-3 border-t border-[#6B7280]/10 pt-4">
              <h4 className="px-3 font-semibold text-md text-[#131B3A]">
                Hi, {user.name}!
              </h4>

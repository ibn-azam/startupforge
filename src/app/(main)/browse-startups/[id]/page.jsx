          ...
          <div className="mt-8 grid gap-5 border-t border-gray-100 pt-6 sm:grid-cols-2">
            {fundingStage && (
              <div>
                ...
                <p className="mt-1 text-sm font-semibold text-[#131B3A]">
                  {fundingStage}
                </p>
              </div>
            )}
            {status && (
              <div>
                ...
                <p className="mt-1 text-sm font-semibold capitalize text-[#131B3A]">
                  {status}
                </p>
              </div>
            )}
            {founderEmail && (
              <div>
                ...
                <p className="mt-1 break-all text-sm font-semibold text-[#131B3A]">
                  {founderEmail}
                </p>
              </div>
            )}
          ...
          <div className="mt-8 border-t border-gray-100 pt-6">
            ...
            {opportunities.length === 0 ? (
              <p className="mt-2 text-sm text-gray-500">
                No active opportunities listed.
              </p>
            ) : (
